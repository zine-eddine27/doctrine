 ...
 */
final class Version20190903142133 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `like` ADD user_id INT NOT NULL, DROP user_like_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `like` ADD user_like_id INT DEFAULT NULL, DROP user_id');
